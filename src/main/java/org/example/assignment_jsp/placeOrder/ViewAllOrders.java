...
@WebServlet(name = "ViewAllOrders" , value = "/ViewPlaceOrders")
...
public class ViewAllOrders extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        List<PlaceOrderDto> orders = placeOrderBo.getOrders();

        req.setAttribute("orders", orders);

        // Forward the request to the JSP page
        RequestDispatcher requestDispatcher = req.getRequestDispatcher("ViewPlaceOrders.jsp");
