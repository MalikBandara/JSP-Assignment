...
@WebServlet(name = "ViewAllWomanProducts" , value = "/WomensProduct")
public class ViewAllWomanProducts extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = req.getRequestDispatcher("WomensProduct.jsp");
