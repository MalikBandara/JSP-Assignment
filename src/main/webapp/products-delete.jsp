                ...
                <div class="card-body">
                    <form action="products-delete" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" id="id" name="id" class="form-control" placeholder="Enter Product ID" required>
                        </div>
...
%>
    Swal.fire({
        ...
        text: 'Your Product has been delete successfully.',
        icon: 'success',
    ...
    Swal.fire({
        title: 'delete Failed',
        text: 'An error occurred while delete your product. Please try again.',
        icon: 'error',
        confirmButtonText: 'OK',
        confirmButtonColor: '#D19C97'
    });
